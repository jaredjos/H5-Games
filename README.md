...
| [NIGHTTRACE](games/nighttrace) | A cinematic horde-survival action game with ten sectors, animated characters and bosses, auto-attacking weapons, Trace circuits, awakenings, and persistent progression. | React, TypeScript, PixiJS, Vite | [Play over HTTPS](https://jaredjos.github.io/H5-Games/nighttrace/) |
