...
export const WEAPONS = {
  ...
  'rift-seeds': {
    ...
    name: 'Astral Verdict',
    shortName: 'Verdict',
    description: 'Calls blue star-lightning down upon the densest enemy clusters.',
  ...
  'comet-swarm': {
    ...
    name: 'Comet Swarm',
    shortName: 'Comets',
    description: 'Ember meteorites orbit the bearer and crush anything crossing their path.',
  ...
  'mirror-bow': {
    ...
    shortName: 'Reavers',
    description: 'Obsidian hunting glaives spin between prey and ricochet from the arena edge.',
...
export const MODULES = {
  ...
  'flux-mirror': {
    id: 'flux-mirror',
    name: 'Ricochet Seal',
    description: 'Accelerates Reaver pursuit and sharpens its arena-edge rebounds.',
  },
  'deep-capacitor': {
    id: 'deep-capacitor',
    name: 'Eventide Vane',
...
export const TRACE_MODS = {
  ...
  crossfire: {
    id: 'crossfire',
    name: 'Crossfire',
    description: 'Every fourth cast repeats through a reflected heading or remote echo.',
  },
  nightglass: {
    id: 'nightglass',
    name: 'Nightglass',
