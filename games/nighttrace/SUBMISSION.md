...
NIGHTTRACE v1.1.0 is an installable mobile web app suitable for HTTPS static
hosting and Add to Home Screen on current Android and iOS browsers. It supports
portrait and landscape layouts, safe-area insets, 44 px minimum touch targets,
touch steering, on-screen Pulse and pause controls, offline campaign play, and
deployment from a nested path.
...
- Input: keyboard, pointer/touch drag, mobile D-pad, Pulse, and pause
